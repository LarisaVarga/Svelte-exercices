...
<button on:mouseenter={triggerBoop} on:click={toggleColor} use:boop={{isBooped, ...boopParams, setter: setIsBooped}}>
	<Icon class="h-6 cursor-pointer {favorite ? favIconColor: initialIconColor}" data="{icon}"/>
</button>